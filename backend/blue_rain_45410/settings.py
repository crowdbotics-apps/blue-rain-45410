"""
Django settings for blue_rain_45410 project.
...
ROOT_URLCONF = 'blue_rain_45410.urls'
...
WSGI_APPLICATION = 'blue_rain_45410.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_rain_45410 API",
    "DESCRIPTION": "API documentation for blue_rain_45410 App",
    "VERSION": "v1",
}
